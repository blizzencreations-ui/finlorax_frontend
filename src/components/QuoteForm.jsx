  ...
  return (
    <div style={{ marginBottom: "16px" }}>
      <label style={{
        ...
        color: "#0b1e3d", marginBottom: "8px", letterSpacing: "0.03em",
      }}>
        {label}
      </label>
      {children}
...
export default function QuoteForm() {
  ...
  return (
    <section id="quote" style={{ padding: "110px 5%", background: "#f7f4ee" }}>
      <div style={{
        ...
        <div className="reveal">
          ...
          <p style={{ color: "#6b7a90", lineHeight: "1.8", marginBottom: "36px", fontSize: "0.97rem" }}>
            Fill out the form and our tax experts will contact you at your preferred time to provide personalized assistance.
          </p>

          {CONTACT_ITEMS.map((item) => (
            <div key={item.text} style={{ display: "flex", gap: "14px", alignItems: "flex-start", marginBottom: "16px" }}>
              <div style={{
              ...
              <span style={{ color: "#2c3e50", fontSize: "0.9rem", lineHeight: "1.7", paddingTop: "8px" }}>
                {item.text}
              </span>
            </div>
          ))}
        ...
        <div className="reveal" style={{
          ...
          <button
            ...
            onMouseEnter={(e) => { e.target.style.transform = "translateY(-2px)"; e.target.style.boxShadow = "0 10px 36px rgba(201,168,76,0.5)"; }}
